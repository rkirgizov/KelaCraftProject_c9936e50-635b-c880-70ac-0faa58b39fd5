...
# Look in "C:\Program Files (x86)\Steam\steamapps\common\Baldurs Gate 3\Data\Projects" d
# for names of mods you have already started
MOD_SUBDIR_NAME="KelaCraftProject_c9936e50-635b-c880-70ac-0faa58b39fd5"
...
git remote set-url origin git@github.com:rkirgizov/KelaCraftProject_c9936e50-635b-c880-70ac-0faa58b39fd5.git
git add --all
